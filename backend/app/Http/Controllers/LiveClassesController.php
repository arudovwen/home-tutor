...
class LiveClassesController extends Controller
{
    ...
    public function getMyLive()
    {
        ...
        $live = LiveClasses::where('school_id', $user->school_id)->where(strtolower('level'), strtolower($user->sub_class))->where(strtolower('day'), strtolower($today))->get();
    ...
    public function getTutorMyLive()
    {
        ...
        $today = strtolower(Carbon::now()->englishDayOfWeek);
        $live = LiveClasses::where('school_id', $user->school_id)->where(strtolower('day'), strtolower($today))->get();
        if (!count($live)) {
          return LiveClasses::where('school_id', $user->school_id)->where(strtolower('day'), 'monday')->get();
        }
        return $live;
    }
