<template>
  <div class="W-100">
    ...
    <b-form @submit.prevent="submit" class="border shadow p-3">
      ...
      <b-modal id="round" size="md" hide-footer>
        ...
        <div v-if="num == template.length-1">
          <b-button  size="sm" type="button" @click="submit">Submit</b-button>
        </div>
        <div class="text-center" v-else>
          <b-button size="sm" v-if="quest == template[num].question.length-1" @click="next">Next Round</b-button>
        </div>
      </b-modal>
      ...
      <b-modal id="response" size="md" hide-footer>
        ...
        <div class="text-center">
          <b-button size="sm" v-if="quest < template[num].question.length" @click="nextQuest">Next Question</b-button>
        </div>
      </b-modal>
    </b-form>
