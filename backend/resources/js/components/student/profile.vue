          ...
          <div class="avatar-profile">
            <b-avatar variant="secondary" :src="detail.profile" class="profile-img" size="6rem">
              <template v-slot:badge>
                <label for="up" class="m-0">
                  <b-icon icon="pencil" size="1rem"></b-icon>
                </label>
                ...
                <b-form-row>
                  <b-col md="6">
                    <b-form-group label="Guardian">
                      <div class="after-edit">
                        <b-form-input v-model="detail.guardian" placeholder disabled></b-form-input>
                      </div>
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Guardian Phone">
                      <div class="after-edit">
                        <b-form-input v-model="detail.guardian_phone" disabled placeholder></b-form-input>
                      </div>
                    </b-form-group>
                  </b-col>
                </b-form-row>
                <b-form-row>
                  <b-col md="6">
                    <b-form-group label="Next of Kin">
                      <div class="after-edit">
                        <b-form-input v-model="detail.next_of_kin" disabled placeholder></b-form-input>
                      </div>
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Next of Kin Phone">
                      <div class="after-edit">
                        <b-form-input v-model="detail.next_of_kin_phone" disabled placeholder></b-form-input>
                      </div>
                    </b-form-group>
                  </b-col>
                </b-form-row>
          ...
          <div class="profile-inner">
            ...
            <div class="personal-form">
              <b-form>
                  ...
                  <b-col md="6">
                    <b-form-group label="Matric Id">
                      <b-form-input disabled placeholder v-model="detail.mat_no"></b-form-input>
                    </b-form-group>
                  </b-col>
                ...
                <b-form-row>
                  <b-col md="6">
                    <b-form-group :label="detail.course_level=='tertiary'?'Level':'Class'">
                      <b-form-input placeholder disabled v-model="detail.student_level"></b-form-input>
                    </b-form-group>
                  </b-col>
                  <b-col md="6" v-if="detail.course_level!=='tertiary'">
                    <b-form-group label="Sub Class">
                      <b-form-input disabled placeholder v-model="detail.sub_class"></b-form-input>
                    </b-form-group>
                  </b-col>
                   <b-col md="6" v-else>
                    <b-form-group v-if="detail.course_level=='tertiary'" label="Study Course">
                      <b-form-input disabled placeholder v-model="detail.study_course"></b-form-input>
                    </b-form-group>
                  </b-col>
                </b-form-row>
                <b-form-row >
                  <b-col md="6"  v-if="detail.course_level=='tertiary'">
                    <b-form-group label="Faculty">
                      <b-form-input disabled placeholder v-model="detail.faculty"></b-form-input>
                    </b-form-group>
                  </b-col>
                  <b-col md="6"  v-if=" detail.course_level !=='primary' || detail.course_level !=='nursery'">
                    <b-form-group label="Department" id="dept">
                      <b-form-input :disabled="detail.course_level=='tertiary'" placeholder v-model="detail.department"></b-form-input>
                    </b-form-group>
                    <b-tooltip triggers="hover"  target="dept" v-if="detail.course_level=='secondary'">Science,Art or Commercial</b-tooltip>
                  </b-col>
