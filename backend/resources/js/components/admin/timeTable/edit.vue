<template>
  <div class="body">
    ...
    <b-row>
      <b-col>
        <b-form-group label="Category">
          <b-form-select size="sm" v-model="level" class="w-50 toCaps">
      ...
      <b-col v-if="level=='tertiary'">
        <b-form-group label=" Level">
          <b-form-select size="sm" required class="custom-select w-50 toCaps" v-model="my_class">
      ...
      <b-col v-if="level!=='tertiary'">
        <b-form-group label="Arm">
          <b-form-select size="sm" required class="custom-select w-50 toCaps" v-model="myclass">
            <option selected disabled value>Select one</option>
            <b-form-select-option
    ...
    <div class="table-responsive">
      ...
      <b-button class="my-4" @click="createTimeTable">Update</b-button>
    </div>
  </div>
</template>
      ...
      axios
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            this.level=res.data.category
            this.myclass = res.data.myclass;
             this.my_class = res.data.my_class;
          }
        });
    },
