<template>
  <div class="form">
    <div class="logo">
      <router-link to="/">
        <img src="/images/imsubeb.png" class="d-inline-block align-top logo-img" alt="logo" />
      </router-link>
      <h6 class="logo-text">IMSUBEB E-LEARNING</h6>
    </div>
    <b-container>
      <b-row class="justify-content-center align-items-center">
        <b-col>
          <b-form @submit.prevent="submit" class="shadow m-auto p-2 p-sm-5">
            <legend class="text-center">Complete Registration</legend>
            <b-form-row>
              <b-col cols="12">
            ...
            <b-form-row>
              <b-col cols="12">
                ...
                <b-form-row>
                  <b-col cols="6">  <b-form-checkbox v-model="subscriber.level" value="nursery">Nursery</b-form-checkbox></b-col>
                    <b-col cols="6"> <b-form-checkbox v-model="subscriber.level" value="primary">Primary</b-form-checkbox></b-col>
                      <b-col cols="6">  <b-form-checkbox v-model="subscriber.level" value="secondary">Secondary</b-form-checkbox></b-col>
                        <b-col cols="6">
                       <b-form-checkbox v-model="subscriber.level" value="tertiary">Tertiary</b-form-checkbox>
    ...
    submit() {
      axios
        ...
        .then((res) => {
          if (res.status == 200) {
            this.$toasted.info(
              "Successful,Check your mail for your login details",
              {
                icon: {
                  name: "check",
                },
