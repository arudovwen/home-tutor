  ...
  <div class="view-resource">
    ...
    <div class="resource-content">
      ...
      <div class="course-course" v-if="modules.length">
        <b-row class="mb-5">
          <b-col>
            <h4 class="text-dark">Course Modules</h4>
            ...
            <div role="tablist" v-for="(item,idx) in modules" :key="idx">
              <b-card no-body class>
                ...
                >
                  <b-card-body>
                    <b-button size="sm" v-if="JSON.parse(item.course).length" variant="success" class="mb-3" @click="edit(item.id)">
                    ...
                    <b-card-text>
                      <div class="mod">
                       <ul v-if="JSON.parse(item.course).length">
                          ...
                          <div  v-else>
                        <router-link to="/tutor/resource/create"> <b-button size="sm" class="mb-3"  variant="success"><b-icon icon="plus-circle-fill" style="width:14px" font-scale="1"></b-icon> Add </b-button></router-link>
    ...
    <b-col cols="5" v-if="modules.length">
      ...
      >
        ...
        <b-button href="#" block variant="success">Views : 14</b-button>
      </b-card>
    </b-col>
  </div>
</template>
