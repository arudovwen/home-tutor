        ...
        <b-form-row>
          <b-col md="4">
            <b-form-group label="Select Class">
              <b-form-select class="toCaps" v-model="option.myclass">
          ...
          <b-col md="4" v-if="tutor.course_level !=='tertiary'">
            <b-form-group class="toCaps" label="Select Arm">
          ...
          <b-col md="4">
            <b-form-group label="Select Subject">
              <b-form-select class="toCaps" v-model="option.subject" v-if="sortedSubject.length">
                <b-form-select-option :value="null" disabled>Select</b-form-select-option>
                <b-form-select-option
                class="toCaps"
                  :value="item"
        ...
        <b-form-row>
          ...
          <b-col md="6" v-if="tutor.course_level !=='tertiary'">
            <b-form-group label="Select Term">
              <b-form-select class="toCaps" v-model="option.session" required>
      ...
      axios
        ...
        .then((res) => {
          if (res.status == 200) {
             ...
             this.option.myclass = res.data[0].class_name
